...
export default function Navbar() {
  ...
  return <>
    <nav className="bg-primary border-gray-200 px-10 fixed top-0 right-0 left-0 z-50">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-center lg:justify-between p-4">
        ...
        <div className={`${isOpen ? "block" : "hidden"} w-full md:block md:w-auto pt-2 lg:pt-0`} id="navbar-default">
          <ul className="font-medium flex flex-row flex-wrap justify-center items-center p-4 md:p-0 mt-4 md:mt-0 md:space-x-8 rtl:space-x-reverse">
            <li>
